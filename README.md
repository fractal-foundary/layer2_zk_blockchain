# Layer2 Zero-Knowledge Blockchain

This rollup is created by deploying up a a private, portable, and modular Polygon CDK Devnet within [Kurtosis](https://github.com/kurtosis-tech/kurtosis).

## Getting Started

Architectural Diagram provided by Kurtosis to give you a overview what we actually build.
...
- For any issues related to repository or any other discussion you might wanna have, connect with me on [linkedin](https://www.linkedin.com/in/gyandev2003).
- Join polygon community as well on [Discord](https://discord.gg/0xpolygondevs), they are very helpful.
